...
<div class="wrapper">
    <main class="hero">
        ...
        <section class="cta-grid" aria-label="Actions de telechargement">
            <a class="btn btn-primary" href="https://lasev.tarentity.com" target="_blank" rel="noopener noreferrer">
                Ouvrir Lasev Web
            </a>
            <a class="btn btn-secondary" href="https://lasev.tarentity.com" target="_blank" rel="noopener noreferrer">
        ...
        <div class="links">
            ...
            <a href="https://lasev.tarentity.com" target="_blank" rel="noopener noreferrer">Support Lasev</a>
        </div>
        <p class="notice">
